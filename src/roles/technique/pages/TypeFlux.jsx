...
export default function TypeFluxPage() {
  ...
  const totalPages =
    Math.ceil(filteredRows.length / ITEMS_PER_PAGE) || 1;
  ...
  const handleDelete = async (row) => {
    ...
    if (!window.confirm(`Delete flow type "${val}"?`)) return;
