    ...
    <div className="filein-card">
      ...
      <div className="filein-card-body">
        <div className="filein-filter-grid">
          ...
          <div className="filein-filter-field">
            ...
            <div className="filein-filter-range">
              <span className="filein-range-sep">from</span>
              <input
                type="date"
                name="creationDateFrom"
                value={filters.creationDateFrom}
                onChange={onFilterChange}
                className="filein-input filein-date"
              />
              <span className="filein-range-sep">to</span>
              <input
                type="date"
                name="creationDateTo"
        ...
        <div className="filein-action-bar">
          <button className="filein-btn-reset" onClick={onReset}>
            Reinitialize
          </button>

          <button className="filein-btn-search" onClick={onSearch}>
            Search
          </button>
        </div>
      </div>
